...
# Mocked version of the tests data from https://appleid.apple.com/auth/keys
...
class AppleTests(OAuth2TestsMixin, TestCase):
    ...
    def get_apple_id_token_payload(self):
        ...
        return {
            ...
            "email": "tests@privaterelay.appleid.com",
            "email_verified": "true",
    ...
    def test_authentication_error(self):
        """ Override base tests because apple posts errors """
        resp = self.client.post(

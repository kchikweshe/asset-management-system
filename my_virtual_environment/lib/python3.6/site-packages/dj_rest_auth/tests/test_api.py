...
class APIBasicTests(TestsMixin, TestCase):
    ...
    def test_login_by_email(self):
        # starting tests without allauth app
        ...
        # tests auth by email in different case
        payload = {
    ...
    def test_blacklisting(self):
        ...
        resp = self.post(self.login_url, data=payload, status_code=200)
        token = resp.data['refresh_token']
        # tests refresh token not included in request data
        self.post(self.logout_url, status_code=401)
        # tests token is invalid or expired
        ...
        # tests token is blacklisted
        self.post(self.logout_url, status_code=401, data={'refresh': token})
        # tests other TokenError, AttributeError, TypeError (invalid format)
